...
import Restore from 'material-ui/svg-icons/file/cloud-upload'
...
class AppList extends React.Component {
  ...
  handleRequestChange(event, index) { this.props.setPage(index) }
      ...
      <div style={ styles.container }>
        {(
           <SelectableList
             ...
             <ListItem
               value="0" primaryText="发现音乐" leftIcon={ <MusicNote /> } />
             <ListItem
               value="1" primaryText="随机音乐" leftIcon={ <MusicVideo /> } />
           </SelectableList>
        )}
        <Divider />
        {(
           <SelectableList
             ...
             <ListItem
               value="2" primaryText="当前音乐" leftIcon={ <MusicNote /> }/>
             {(this.props.username === '登录') ? null : (
                <div>
                  <ListItem
                    value="3" primaryText="上传音乐" leftIcon={ <Upload /> }/>
                  <ListItem
                    value="4" primaryText="历史下载" leftIcon={ <Restore /> }/>
                </div>
             )}
           </SelectableList>
        )}
        ...
        {(this.props.username === '登录') ? null : (
           <SelectableList
             ...
             <ListItem
               value="5" primaryText="我喜欢的音乐" leftIcon={ <QueueMusic /> }/>
           </SelectableList>
        )}
      </div>
    )
